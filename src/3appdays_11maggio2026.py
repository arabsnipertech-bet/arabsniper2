...
def build_signal_package(fid, mk, s_h, s_a):
    ...
    # Segnale ⚽⚽: resta visivo, ma non guida il motore.
    gg_ht_sniper = bool(
        (gold_ok and over_level >= 2 and combined_ht_avg >= 1.10 and (favorite_fertile or inv_ok))
        or (market_ok and drop_medium_or_strong and combined_ht_avg >= 1.05)
    )
    if gg_ht_sniper:
        tags.append("⚽⚽")
